...
from utils_sathmr.transforms import rot6d_to_axis_angle, img2patch_flat, img2patch, to_zorder
from utils_sathmr.map import build_z_map
from utils_sathmr import constants
from configs.paths import smpl_mean_path

from models.encoders import build_encoder
#from backbones.efficient_vit import build_encoder
...
class Model(nn.Module):
    ...
    def __init__(self, encoder, decoder,
        ...
        for attr in ["mask_token", "pos_embed", "patch_embed", "cls_token", "register_tokens"]:
            if hasattr(self.encoder, attr):
                delattr(self.encoder, attr)
